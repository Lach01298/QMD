...
public class CTAddQMDRecipe implements IAction
{
	...
	public CTAddQMDRecipe(QMDRecipeHandler recipeHandler, List objects)
	{
	...
	public String describe()
	{
		if (inputsAllNull || ingredientError || wasNull || wrongSize) {
			...
			return String.format("Error: Failed to add %s recipe: %s", recipeHandler.getName(), QMDRecipeHelper.getRecipeString(itemIngredients, fluidIngredients, particleIngredients, itemProducts, fluidProducts, particleProducts));
		}
		return String.format("Adding %s recipe: %s", recipeHandler.getName(), QMDRecipeHelper.getRecipeString(itemIngredients, fluidIngredients, particleIngredients, itemProducts, fluidProducts, particleProducts));
	}
