...
public class TileContainmentPort extends TileContainmentPart implements ITileInventory
{
	
	private final @Nonnull NonNullList<ItemStack> inventoryStacks = NonNullList.withSize(2, ItemStack.EMPTY);
	private IContainmentController controller;
	...
	@Override
	public void onMachineAssembled(Containment chamber) 
	{
		if(chamber.controller instanceof IContainmentController)
		{
			controller =  (IContainmentController) chamber.controller;
		}
