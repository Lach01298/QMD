...
public class BlockContainmentVent extends BlockContainmentPart
{

	public BlockContainmentVent()
	{
		super();
	...
	{
		return new TileContainmentVent();
	}
	...
	public void setState(boolean isActive, TileEntity tile)
	{
		...
		if (!world.isRemote && state.getBlock() instanceof BlockContainmentVent)
		{
