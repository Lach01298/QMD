...
public class BlockNeutralContainmentController extends BlockContainmentPart
{
	...
	public void setState(boolean isActive, TileEntity tile)
	{
		...
		if (!world.isRemote && state.getBlock() instanceof BlockNeutralContainmentController)
		{
