...
public class Containment extends CuboidalMultiblock<IContainmentPart, ContainmentUpdatePacket>
		implements ILogicMultiblock<ContainmentLogic, IContainmentPart>
{
	...
	public List<Tank> tanks = Lists.newArrayList(
			...
			new Tank(QMDConfig.accelerator_base_output_tank_capacity, null), new Tank(1, null));
