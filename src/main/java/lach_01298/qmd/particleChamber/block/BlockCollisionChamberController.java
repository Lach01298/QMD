...
public class BlockCollisionChamberController extends BlockParticleChamberPart implements IActivatable
{
	public BlockCollisionChamberController()
	{
		super();
	...
	{
		return new TileCollisionChamberController();
	}
	...
	public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
	{
		...
		if (!world.isRemote)
		{
			if (world.getTileEntity(pos) instanceof TileCollisionChamberController)
			{
				TileCollisionChamberController controller = (TileCollisionChamberController) world.getTileEntity(pos);

				if (controller.getMultiblock() != null && controller.getMultiblock().isAssembled())
				{
					player.openGui(QMD.instance, GUI_ID.COLLISION_CHAMBER, world, pos.getX(), pos.getY(), pos.getZ());
					return true;
				}
			}
		}
