...
public class CollisonChamberLogic extends ParticleChamberLogic
{
	...
	public CollisonChamberLogic(ParticleChamberLogic oldLogic)
	{
		super(oldLogic);
		
		getMultiblock().beams.add(new ParticleStorageAccelerator()); //input 2
		getMultiblock().beams.add(new ParticleStorageAccelerator()); //output 1
		getMultiblock().beams.add(new ParticleStorageAccelerator()); //output 2
		getMultiblock().beams.add(new ParticleStorageAccelerator()); //output 3
		getMultiblock().beams.add(new ParticleStorageAccelerator()); //output 4
	}
