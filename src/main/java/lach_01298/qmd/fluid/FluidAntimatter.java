...
public class FluidAntimatter extends Fluid
{


	public FluidAntimatter(String fluidName, String textureName, Integer color)
	{
	...
	public FluidAntimatter(String fluidName, Integer colour)
	{
