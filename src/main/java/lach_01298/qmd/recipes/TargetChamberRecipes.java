...
public class TargetChamberRecipes extends QMDRecipeHandler
{
	...
	public void addRecipes()
	{
		...
		addQMDBalancedRecipe("IngotGold", new ParticleStack(Particles.proton, 1, 12500), "ingotMercury",
		...
		addQMDBalancedRecipe("ingotGold", new ParticleStack(Particles.deuteron,1,18000), "ingotMercury",
