...
public class BlockAcceleratorVent extends BlockAcceleratorPart
{

	public BlockAcceleratorVent()
	{
		super();
	...
	{
		return new TileAcceleratorVent();
	}
	...
	public void setState(boolean isActive, TileEntity tile)
	{
		...
		if (!world.isRemote && state.getBlock() instanceof BlockAcceleratorVent)
		{
