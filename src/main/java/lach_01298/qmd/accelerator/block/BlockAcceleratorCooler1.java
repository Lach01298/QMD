...
public class BlockAcceleratorCooler1 extends BlockMetaQMDPart<CoolerType1>
{

	public final static PropertyEnum TYPE = PropertyEnum.create("type", CoolerType1.class);

	public BlockAcceleratorCooler1()
	{
		super(CoolerType1.class, TYPE);
	}
