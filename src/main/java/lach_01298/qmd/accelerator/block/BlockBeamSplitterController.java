...
{
	public BlockBeamSplitterController()
	{
		super();
	...
	{
		return new TileBeamSplitterController();
	}
	...
	public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
	{
		...
		if (!world.isRemote)
		{
			if (world.getTileEntity(pos) instanceof TileBeamSplitterController)
			{
				TileBeamSplitterController controller = (TileBeamSplitterController) world.getTileEntity(pos);
