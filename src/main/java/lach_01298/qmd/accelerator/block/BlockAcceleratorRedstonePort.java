...
public class BlockAcceleratorRedstonePort extends BlockAcceleratorPart
{

	public BlockAcceleratorRedstonePort()
	{
		super();
	...
	{
		return new TileAcceleratorRedstonePort();
	}
	...
	public void setState(boolean isActive, TileEntity tile)
	{
		...
		if (!world.isRemote && state.getBlock() instanceof BlockAcceleratorRedstonePort)
		{
	 ...
	 public int getWeakPower(IBlockState blockState, IBlockAccess blockAccess, BlockPos pos, EnumFacing side)
	 {
		 ...
		 if(tileentity instanceof TileAcceleratorRedstonePort)
		 {
			 TileAcceleratorRedstonePort port = (TileAcceleratorRedstonePort) tileentity;
