...
public class GuiDeceleratorController extends GuiLogicMultiblockController<Accelerator, AcceleratorLogic, IAcceleratorPart, AcceleratorUpdatePacket, TileDeceleratorController, TileContainerInfo<TileDeceleratorController>, DeceleratorLogic>
{
	...
	public GuiDeceleratorController(Container inventory, EntityPlayer player, TileDeceleratorController controller, String textureLocation)
	{
	...
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY)
	{
		...
		String title = Lang.localize("gui.qmd.container.decelerator_controller.name");
