...
public class GuiNeutralContainmentController extends GuiLogicMultiblock<Containment, NeutralContainmentLogic, IContainmentController>
{
	...
	public void renderTooltips(int mouseX, int mouseY) 
	{
		...
		guiParticle.drawToolTipBoxwithFocus(multiblock.beams.get(0).getParticleStack(), guiLeft+27, guiTop+28, mouseX, mouseY);
		guiParticle.drawToolTipBoxwithFocus(multiblock.beams.get(1).getParticleStack(), guiLeft+131, guiTop+28, mouseX, mouseY);
	...
	public List<String> heatInfo() 
	{
		...
		info.add(TextFormatting.RED + Lang.localise("gui.qmd.container.accelerator.heating",Units.getSIFormat(multiblock.heating + multiblock.getMaxExternalHeating(),"H/t")));
