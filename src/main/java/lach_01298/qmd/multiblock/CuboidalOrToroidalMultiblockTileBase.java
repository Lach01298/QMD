...
public abstract class CuboidalOrToroidalMultiblockTileBase<T extends MultiblockBase> extends MultiblockTileBase<T>
{
	...
	private BlockFacings externalFacings;

	public CuboidalOrToroidalMultiblockTileBase(Class<T> tClass, int toroidThickness)
	{
		super(tClass);

		position = PartPosition.Unknown;
		externalFacings = BlockFacings.NONE;
	 ...
	 */
	@Nonnull
	public BlockFacings getExternalDir()
	{
	...
	public EnumFacing getExternalFacing()
	{
		...
		if (null == facing)
		{
			...
			BlockFacings out = this.getExternalDir();
	...
	public void recalculateExternalDirection(BlockPos minCoord, BlockPos maxCoord)
	{
		...
		this.externalFacings = BlockFacings.from(downFacing, upFacing, northFacing, southFacing, westFacing, eastFacing);
