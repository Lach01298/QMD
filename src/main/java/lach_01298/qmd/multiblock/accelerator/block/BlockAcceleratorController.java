...
public class BlockAcceleratorController extends BlockAcceleratorPartBase
{
	...
	{
		return new TileAcceleratorController();
	}
	...
	public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
	{
		...
		if (!world.isRemote)
		{
			if (world.getTileEntity(pos) instanceof TileAcceleratorController)
			{
				TileAcceleratorController controller = (TileAcceleratorController) world.getTileEntity(pos);
	...
	public void setState(boolean isActive, TileEntity tile)
	{
		...
		if (!world.isRemote && state.getBlock() == QMDBlocks.acceleratorCotroller)
		{
