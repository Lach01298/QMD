...
public class TileAcceleratorOutlet extends TileAcceleratorPart implements ITileFluid
{
	...
	public void pushFluidToSide(@Nonnull EnumFacing side)
	{
			...
			if (tile == null || tile instanceof TileAcceleratorOutlet)
				return;
