package lach_01298.qmd.multiblock.accelerator.ring.block;
...
public class BlockRingAcceleratorController extends BlockAcceleratorPart
{

	public BlockRingAcceleratorController()
	{
		super();
	...
	{
		return new TileRingAcceleratorController();
	}
	...
	public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
	{
		...
		if (!world.isRemote)
		{
			if (world.getTileEntity(pos) instanceof TileRingAcceleratorController)
			{
	...
	public void setState(boolean isActive, TileEntity tile)
	{
		...
		if (!world.isRemote && state.getBlock() == QMDBlocks.ringAcceleratorCotroller)
		{
