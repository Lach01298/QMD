package lach_01298.qmd.multiblock.accelerator.linear.block;
...
import lach_01298.qmd.multiblock.accelerator.block.BlockAcceleratorPart;
...
public class BlockLinearAcceleratorController extends BlockAcceleratorPart
{

	public BlockLinearAcceleratorController()
	{
		super();
	...
	{
		return new TileLinearAcceleratorController();
	}
	...
	public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
	{
		...
		if (!world.isRemote)
		{
			if (world.getTileEntity(pos) instanceof TileLinearAcceleratorController)
			{
				TileLinearAcceleratorController controller = (TileLinearAcceleratorController) world.getTileEntity(pos);
				
				
				
				System.out.println("RF:"+controller.getMultiblock().RFCavityNumber+" Quad:"+controller.getMultiblock().quadrupoleNumber);
	...
	public void setState(boolean isActive, TileEntity tile)
	{
		...
		if (!world.isRemote && state.getBlock() instanceof BlockLinearAcceleratorController)
		{
