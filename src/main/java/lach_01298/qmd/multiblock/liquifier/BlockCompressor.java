...
import nc.multiblock.heatExchanger.block.BlockHeatExchangerPart;
...
public class BlockCompressor extends BlockHeatExchangerPart implements ISidedProperty<HeatExchangerTubeSetting>
{
	...
	{
		return state.withProperty(DOWN, getProperty(world, pos, EnumFacing.DOWN))
				.withProperty(UP, getProperty(world, pos, EnumFacing.UP))
				.withProperty(NORTH, getProperty(world, pos, EnumFacing.NORTH))
