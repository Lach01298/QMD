...
public class TargetChamberUpdatePacket extends ParticleChamberUpdatePacket
{
	...
	public static class Handler extends
			MultiblockUpdatePacket.Handler<ParticleChamber, IParticleChamberPart, ParticleChamberUpdatePacket, TileTargetChamberController, TileContainerInfo<TileTargetChamberController>, TargetChamberUpdatePacket>
	{
