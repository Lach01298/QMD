...
public class BlockDecayChamberController extends BlockParticleChamberPart
{
	public BlockDecayChamberController()
	{
		super();
	...
	{
		return new TileDecayChamberController();
	}
	...
	public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
	{
		...
		if (!world.isRemote)
		{
			if (world.getTileEntity(pos) instanceof TileDecayChamberController)
			{
				TileDecayChamberController controller = (TileDecayChamberController) world.getTileEntity(pos);

				if (controller.getMultiblock() != null && controller.getMultiblock().isAssembled())
				{
					player.openGui(QMD.instance, GUI_ID.DECAY_CHAMBER, world, pos.getX(), pos.getY(), pos.getZ());
					return true;
				}
			}
		}
	...
	public void setState(boolean isActive, TileEntity tile)
	{
		...
		if (!world.isRemote && state.getBlock() instanceof BlockDecayChamberController)
		{
