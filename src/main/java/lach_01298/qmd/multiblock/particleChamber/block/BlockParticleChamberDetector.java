...
public class BlockParticleChamberDetector extends BlockMetaQMDPart<EnumTypes.DetectorType>
{

	public final static PropertyEnum TYPE = PropertyEnum.create("type", EnumTypes.DetectorType.class);

	public BlockParticleChamberDetector()
	{
		super(EnumTypes.DetectorType.class, TYPE);
	}
	...
	{
		if(state.getValue(TYPE) == EnumTypes.DetectorType.SILLICON_TRACKER || state.getValue(TYPE) == EnumTypes.DetectorType.WIRE_CHAMBER)
		{
			return true;
		}
		return false;
