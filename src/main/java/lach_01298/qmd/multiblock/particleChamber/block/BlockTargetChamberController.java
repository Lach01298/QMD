...
public class BlockTargetChamberController extends BlockParticleChamberPart
{
	...
	{
		return new TileTargetChamberController();
	}
	...
	public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
	{
		...
		if (!world.isRemote)
		{
			if (world.getTileEntity(pos) instanceof TileTargetChamberController)
			{
				TileTargetChamberController controller = (TileTargetChamberController) world.getTileEntity(pos);
