...
public class BlockParticleChamberTarget extends BlockParticleChamberPart 
{


	
	public BlockParticleChamberTarget()
	{
		super();
	}
	...
	{
		return new TileParticleChamberTarget();
	}
			...
			EnumFacing facing, float hitX, float hitY, float hitZ)
	{
		...
		if (player.getHeldItemMainhand().isEmpty() && world.getTileEntity(pos) instanceof TileParticleChamberTarget)
		{
			TileParticleChamberTarget target = (TileParticleChamberTarget) world.getTileEntity(pos);
