...
public class TileVacuumChamberVent extends TileVacuumChamberPart implements ITileFluid, ITickable
{
	...
	{
		if (getBlockType() instanceof BlockVacuumChamberVent)
		{
			((BlockVacuumChamberVent) getBlockType()).setState(isActive, this);
		}
	}
	...
	public void pushFluidToSide(@Nonnull EnumFacing side)
	{
		...
		if (tile == null || tile instanceof TileVacuumChamberVent)
			return;
