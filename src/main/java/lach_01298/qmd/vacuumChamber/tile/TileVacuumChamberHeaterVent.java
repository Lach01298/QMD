...
public class TileVacuumChamberHeaterVent extends TileVacuumChamberPart implements ITileFluid, ITickable
{
	...
	public TileVacuumChamberHeaterVent()
	{
	...
	{
		if (getBlockType() instanceof BlockVacuumChamberHeaterVent)
		{
			((BlockVacuumChamberHeaterVent) getBlockType()).setState(isActive, this);
		}
	}
	...
	public @Nonnull List<Tank> getTanks()
	{
		...
		{
			if(getLogic() instanceof NucleosynthesisChamberLogic)
			{
				return getMultiblock().isAssembled() ? getMultiblock().tanks.subList(2, 4) : backupTanks;
			}
		}
	...
	public void pushFluidToSide(@Nonnull EnumFacing side)
	{
		...
		if (tile == null || tile instanceof TileVacuumChamberHeaterVent)
			return;
