...
public class BlockExoticContainmentController extends BlockVacuumChamberPart implements IActivatable
{
	public BlockExoticContainmentController()
	{
		super();
	...
	{
		return new TileExoticContainmentController();
	}
	...
	public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
	{
		...
		if (!world.isRemote)
		{
			if (world.getTileEntity(pos) instanceof TileExoticContainmentController)
			{
				TileExoticContainmentController controller = (TileExoticContainmentController) world.getTileEntity(pos);
