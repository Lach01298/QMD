...
public class BlockNucleosynthesisChamberController extends BlockVacuumChamberPart implements IActivatable
{
	public BlockNucleosynthesisChamberController()
	{
		super();
	...
	{
		return new TileNucleosynthesisChamberController();
	}
	...
	public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
	{
		...
		if (!world.isRemote)
		{
			if (world.getTileEntity(pos) instanceof TileNucleosynthesisChamberController)
			{
				TileNucleosynthesisChamberController controller = (TileNucleosynthesisChamberController) world.getTileEntity(pos);

				if (controller.getMultiblock() != null && controller.isMultiblockAssembled())
				{
					player.openGui(QMD.instance, GUI_ID.NUCLEOSYNTHESIS_CHAMBER, world, pos.getX(), pos.getY(), pos.getZ());
					return true;
				}
			}
		}
