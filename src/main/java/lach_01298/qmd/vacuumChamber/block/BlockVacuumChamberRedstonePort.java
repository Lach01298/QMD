...
public class BlockVacuumChamberRedstonePort extends BlockVacuumChamberPart
{
	...
	public BlockVacuumChamberRedstonePort()
	{
		super();
	...
	{
		return new TileVacuumChamberRedstonePort();
	}
	...
	public void setState(boolean isActive, TileEntity tile)
	{
		...
		if (!world.isRemote && state.getBlock() instanceof BlockVacuumChamberRedstonePort)
		{
	 ...
	 public int getWeakPower(IBlockState blockState, IBlockAccess blockAccess, BlockPos pos, EnumFacing side)
	 {
		 ...
		 {
			 TileVacuumChamberRedstonePort port = (TileVacuumChamberRedstonePort) tileentity;
