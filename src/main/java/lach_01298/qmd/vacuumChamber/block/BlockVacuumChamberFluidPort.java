...
public class BlockVacuumChamberFluidPort extends BlockVacuumChamberPart
{

	public BlockVacuumChamberFluidPort()
	{
		super();
	...
	{
		return new TileVacuumChamberFluidPort();
	}
	...
	public void setState(boolean isActive, TileEntity tile)
	{
		...
		if (!world.isRemote && state.getBlock() instanceof BlockVacuumChamberFluidPort)
		{
