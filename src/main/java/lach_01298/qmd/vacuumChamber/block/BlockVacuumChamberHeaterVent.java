...
public class BlockVacuumChamberHeaterVent extends BlockVacuumChamberPart
{

	public BlockVacuumChamberHeaterVent()
	{
		super();
	...
	{
		return new TileVacuumChamberHeaterVent();
	}
	...
	public void setState(boolean isActive, TileEntity tile)
	{
		...
		if (!world.isRemote && state.getBlock() instanceof BlockVacuumChamberHeaterVent)
		{
