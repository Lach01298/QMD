...
{
	public static class TileOreLeacher extends TileItemFluidProcessorLegacy
	{
	...
	public static Pair<Double, Double> getMaxBaseStats(BasicRecipeHandler handler, double defaultTime, double defaultPower) {
		double maxBaseTime = 1D;
		double maxBasePower = 0D;
		for (BasicRecipe recipe : handler.getRecipeList()) {
			if (recipe != null) {
