...
import lach_01298.qmd.jei.recipe.JEIRecipeWrapper;
...
public abstract class QMDProcessorCategory<WRAPPER extends JEIRecipeWrapper> implements IRecipeCategory<WRAPPER>
{
	...
	public QMDProcessorCategory(IGuiHelper guiHelper, String name,String backgroundTexture, ItemStack iconItem, int backX, int backY, int backWidth, int backHeight)
	{
