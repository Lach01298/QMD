...
public class NeutralContainmentRecipeMaker
{
	...
	public static List<NeutralContainmentRecipe> getRecipes(IJeiHelpers helpers)
	{
		...
		for (QMDRecipe recipe : recipes)
		{
			...
			ParticleStack inputParticle1 = recipe.getParticleIngredients().get(0).getStack();
			...
			NeutralContainmentRecipe jeiRecipe = new NeutralContainmentRecipe(inputParticle1,inputParticle2, outputFluid, maxEnergy);
